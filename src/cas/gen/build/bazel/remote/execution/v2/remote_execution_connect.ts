...
import { ActionResult, BatchReadBlobsRequest, BatchReadBlobsResponse, BatchUpdateBlobsRequest, BatchUpdateBlobsResponse, ExecuteRequest, FindMissingBlobsRequest, FindMissingBlobsResponse, GetActionResultRequest, GetCapabilitiesRequest, GetTreeRequest, GetTreeResponse, ServerCapabilities, UpdateActionResultRequest, WaitExecutionRequest } from "./remote_execution_pb.js";
 ...
 *
 * @generated from service build.bazel.remote.execution.v2.Execution
 */
export const Execution = {
  typeName: "build.bazel.remote.execution.v2.Execution",
  methods: {
    /**
     ...
     *
     * @generated from rpc build.bazel.remote.execution.v2.Execution.Execute
     */
    execute: {
      name: "Execute",
      I: ExecuteRequest,
     ...
     *
     * @generated from rpc build.bazel.remote.execution.v2.Execution.WaitExecution
     */
    waitExecution: {
      name: "WaitExecution",
      I: WaitExecutionRequest,
      O: Operation,
      kind: MethodKind.ServerStreaming,
    },
  }
 ...
 * respect the information provided.
 *
 * @generated from service build.bazel.remote.execution.v2.ActionCache
 */
export const ActionCache = {
  typeName: "build.bazel.remote.execution.v2.ActionCache",
  methods: {
    /**
     ...
     *
     * @generated from rpc build.bazel.remote.execution.v2.ActionCache.GetActionResult
     */
    getActionResult: {
      name: "GetActionResult",
      I: GetActionResultRequest,
      O: ActionResult,
     ...
     *   entry to the cache.
     *
     * @generated from rpc build.bazel.remote.execution.v2.ActionCache.UpdateActionResult
     */
    updateActionResult: {
      name: "UpdateActionResult",
      I: UpdateActionResultRequest,
      O: ActionResult,
      kind: MethodKind.Unary,
    },
  }
 ...
 * respect the information provided.
 *
 * @generated from service build.bazel.remote.execution.v2.ContentAddressableStorage
 */
export const ContentAddressableStorage = {
  typeName: "build.bazel.remote.execution.v2.ContentAddressableStorage",
  methods: {
    /**
     ...
     *
     * @generated from rpc build.bazel.remote.execution.v2.ContentAddressableStorage.FindMissingBlobs
     */
    findMissingBlobs: {
      name: "FindMissingBlobs",
      I: FindMissingBlobsRequest,
      O: FindMissingBlobsResponse,
      kind: MethodKind.Unary,
    },
    /**
     ...
     *
     * @generated from rpc build.bazel.remote.execution.v2.ContentAddressableStorage.BatchUpdateBlobs
     */
    batchUpdateBlobs: {
      name: "BatchUpdateBlobs",
      I: BatchUpdateBlobsRequest,
      O: BatchUpdateBlobsResponse,
      kind: MethodKind.Unary,
    },
    /**
     ...
     * status.
     *
     * @generated from rpc build.bazel.remote.execution.v2.ContentAddressableStorage.BatchReadBlobs
     */
    batchReadBlobs: {
      name: "BatchReadBlobs",
      I: BatchReadBlobsRequest,
      O: BatchReadBlobsResponse,
      kind: MethodKind.Unary,
    },
    /**
     ...
     *
     * @generated from rpc build.bazel.remote.execution.v2.ContentAddressableStorage.GetTree
     */
    getTree: {
      name: "GetTree",
      I: GetTreeRequest,
 ...
 *
 * @generated from service build.bazel.remote.execution.v2.Capabilities
 */
export const Capabilities = {
  typeName: "build.bazel.remote.execution.v2.Capabilities",
  methods: {
    /**
     ...
     * There are no method-specific errors.
     *
     * @generated from rpc build.bazel.remote.execution.v2.Capabilities.GetCapabilities
     */
    getCapabilities: {
